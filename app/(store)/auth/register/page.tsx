    ...
    <div className="bg-background min-h-[80vh] flex items-center justify-center py-12 px-margin-mobile md:px-margin-desktop">
      <div className="w-full max-w-md bg-surface-container rounded-2xl p-8 md:p-12 shadow-sm border border-outline-variant/30">
        <div className="text-center mb-8">
          <h1 className="font-display text-headline-md text-on-surface mb-2">Create Account</h1>
          <p className="font-body text-body-sm text-on-surface-variant">Join the {STORE_NAME} family</p>
        </div>

        <form className="space-y-4">
          <div className="space-y-2">
            <label className="font-body text-body-sm text-on-surface" htmlFor="name">Full Name</label>
          ...
          <Button type="submit" className="w-full h-12 text-base mt-2">Create Account</Button>
        </form>
